...
// set them as dynamic properties inside of this (based on their passed in data) DONE lines8, 9 ,10
function CookieStand(locationName, minCustomersPerHour, maxCustomersPerHour, avgCookiesPerSale) {
  this.locationName = locationName;
  this.minCustomerwsPerHour = minCustomersPerHour;
  this.maxCustomersPerHour = maxCustomersPerHour
  this.avgCookiesPerSale = avgCookiesPerSale;
  this.customersEachHour = [];
  this.cookiesEachHour = [];
  this.totalDailyCookies = 0;
  // TODO: // push "this" object to the CookieStand.all array on every instantiation DONE line 16

  CookieStand.all.push(this)
  // 'this' is referred to as the context object or contextual this
}

// Just like properties inside the constructor dfunction define properties for the object

// functions...when attached to an object called methods
...
CookieStand.prototype.calcCookiesEachHour = function() {
  // TODO: invoke the method that calculates number of customers each hour here DONE line33
...
CookieStand.prototype.render = function() {
  ...
  this.calcCookiesEachHour(); // first domino  that kicks off all the rest of them
...
// 3. assign the property to the newly created element (text)
// 4. append/attch to parent
